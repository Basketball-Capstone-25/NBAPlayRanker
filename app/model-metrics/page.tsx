...
//
// Model Performance (defense page) — revamped UI
//
// What this page does (coach-friendly):
// - We’re predicting a play type’s PPP (points per possession).
// - RMSE / MAE tell you how far off the prediction is (error), not how many points a team will score.
// - Lower error = “closer to the truth” more consistently across seasons.
//
// Two kinds of evidence shown here:
// (A) HOLDOUT / GENERALIZATION (season holdout) → /metrics/baseline-vs-ml
// (B) TUNING / SEARCH evidence (features + best params) → /analysis/ml
//
// NOTE:
// Tuning runs are expensive. This page loads FAST (pipeline + holdout first),
// and only loads tuning when you open the “Tuning” tab.
